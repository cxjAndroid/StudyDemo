...
package com.example.andychen.swipy_refresh_layout;
...
public class RefreshLayout extends ViewGroup {
    ...
    //Y轴滑动多少像素唤出下拉刷新
    private int mRefreshYDis;


    public int getRefreshYDis() {
        return mRefreshYDis;
    }

    public void setRefreshYDis(int mRefreshYDis) {
        this.mRefreshYDis = mRefreshYDis;
    }
    ...
    /**
     * 显示底部的加载转圈圈
     * 注意如果RefreshLayout没有覆盖到屏幕最底部的话圈圈会看不见的
     */
    public void setBottomRefreshing() {
        if (!mRefreshing) {
            mRefreshing = true;
            setTargetOffsetTopAndBottom((int) (screenHeight - mCircleHeight - mSpinnerFinalOffset), true /* requires update */);
            mNotify = false;
            startScaleUpAnimation(mRefreshListener);
        }
    }
...
//    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (yDiff - mTouchSlop > mRefreshYDis && !mIsBeingDragged) {
    ...
    public void setDefaultColor() {
        this.setColorSchemeResources(android.R.color.holo_blue_bright, android.R.color.holo_green_light,
